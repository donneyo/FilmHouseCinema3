...
public class BookModel2 {
	...
	private static Logger log = Logger.getLogger(BookModel2.class);
	...
	public BookBean2 findByPK(long pk) throws ApplicationException {
	...
	public long add(BookBean2 bean) throws ApplicationException, DuplicateRecordException2 {
		log.debug("Model add Started");
		Connection conn = null;
		int pk = 0;
		
		UserModel2 uModel=new UserModel2();
		UserBean2 uBean=uModel.findByPK(bean.getUserId());
	...
	public void delete(BookBean2 bean) throws ApplicationException {
	...
	public void update(BookBean2 bean) throws ApplicationException, DuplicateRecordException2 {
	...
	public List search(BookBean2 bean) throws ApplicationException {
     ...
     */
    public List search(BookBean2 bean, int pageNo, int pageSize)
            throws ApplicationException {
