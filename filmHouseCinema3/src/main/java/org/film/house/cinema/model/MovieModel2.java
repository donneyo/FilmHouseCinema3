...
public class MovieModel2 {
	private static Logger log = Logger.getLogger(MovieModel2.class);
	...
	public MovieBean2 findByName(String name) throws ApplicationException {
	...
	public MovieBean2 findByPK(long pk) throws ApplicationException {
	...
	public List search(MovieBean2 bean) throws ApplicationException {
        return search(bean, 0, 0);
    }
	
	
	  public List search(MovieBean2 bean, int pageNo, int pageSize)
	...
	public long add(MovieBean2 bean) throws ApplicationException, DuplicateRecordException2 {
		log.debug("Model add Started");
		Connection conn = null;
		int pk = 0;
		MovieBean2 duplicataRole = findByName(bean.getName());

		// Check if create Role already exist
		if (duplicataRole != null) {
			throw new DuplicateRecordException2("Movie already exists");
		}
		try {
			conn = JDBCDataSource.getConnection();
			pk = nextPK();
	...
	public void delete(MovieBean2 bean) throws ApplicationException {
	...
	public void update(MovieBean2 bean) throws ApplicationException, DuplicateRecordException2 {
